...
/**
 * Excepción lanzada cuando no se encuentra un viaje con el identificador proporcionado.
 *
...
public class TripNotFoundException extends RuntimeException {
	...
	/**
	 * Construye la excepción con un mensaje que incluye el identificador del viaje no encontrado.
	 *
	 * @param id identificador del viaje que no existe en el sistema
	 */
